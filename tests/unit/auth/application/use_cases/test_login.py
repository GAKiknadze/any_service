...
@pytest.mark.asyncio
async def test_login_success(fake_user_repo, fake_session_repo, fake_password_service, fake_token_service):
    user_id = uuid4()
...
@pytest.mark.asyncio
async def test_login_invalid_password(fake_user_repo, fake_session_repo, fake_password_service, fake_token_service):
    user_id = uuid4()
